        ...
        <div className="container">
            <div className="filters">
                <div className="filter-group">
                    ...
                    />
                    <button type="datetime-local" onClick={() => { handleFilterChange('fridge_id', '') }} >
                        Clear Fridge Filter
                    </button>
                </div>
                <div className="filter-group">
                    ...
                    />
                    <button type="datetime-local" onClick={() => { handleFilterChange('instrument_name', '') }} >
                ...
                <div className="filter-group">
                    ...
                    />
                    <button type="datetime-local" onClick={() => { handleFilterChange('parameter_name', '') }} >
                ...
                <div className="filter-group">
                    ...
                    />
                    <button type="datetime-local" onClick={() => { handleFilterChange('applied_value', '', true, 'min'); handleFilterChange('applied_value', '', true, 'max') }} >
                        Clear Value Filter
                    </button>
                </div>
                <div className="filter-group">
                    ...
                    />
                    <button type="datetime-local" onClick={() => { handleFilterChange('timestamp', '', true, 'min'); handleFilterChange('timestamp', '', true, 'max') }} >
